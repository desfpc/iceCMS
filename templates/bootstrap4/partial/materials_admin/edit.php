...
?><div class="row">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="name" name="name" aria-describedby="nameHelp" placeholder="Наименование материала" required value="<?= $this->moduleData->material->params['name']; ?>">
        </div>
    </div>
    <div class="form-group row">
        <label for="id_char" class="col-sm-2 col-form-label text-right">Идентификатор (En)</label>
        <div class="col-sm-10">
            <input type="text" class="form-control" id="id_char" name="id_char" aria-describedby="id_charHelp" placeholder="Буквенный идентификатор (En)" value="<?= $this->moduleData->material->params['id_char']; ?>">
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <select class="form-control selectpicker" data-live-search="true" id="material_type_id" name="material_type_id" aria-describedby="parent_idHelp" placeholder="Родительский тип материала">
                <option value="<?=$this->moduleData->material->params['material_type_id']?>" selected><?=$this->moduleData->material->params['material_type_name']?></option>
            </select>
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            <select class="form-control selectpicker" data-live-search="false" name="language" aria-describedby="languageHelp" placeholder="Язык">
                <?php
        ...
        <div class="col-sm-4">
            <select class="form-control selectpicker" data-live-search="false" name="status_id" aria-describedby="status_idHelp" placeholder="Статус">
                <?php
