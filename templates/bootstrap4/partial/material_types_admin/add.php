...
?>
    <form id="matTypeAddForm" action="/admin/material_types_admin/?mode=add" method="post">
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="name" name="name" aria-describedby="nameHelp"
                       placeholder="Наименование типа материала" required value="<?= $this->values->name; ?>">
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="name_en" name="name_en" aria-describedby="name_enHelp"
                       placeholder="Наименование (En)" value="<?= $this->values->name_en; ?>">
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="name_de" name="name_de" aria-describedby="name_deHelp"
                       placeholder="Наименование (De)" value="<?= $this->values->name_de; ?>">
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="ordernum" name="ordernum" aria-describedby="ordernumHelp"
                       placeholder="Порядок сортировки" value="<?= $this->values->ordernum; ?>">
            </div>
        </div>
        <div class="form-check">
            <input type="checkbox" class="form-check-input" id="sitemenu" name="sitemenu"
                   value="1" <?php if ($this->values->sitemenu == 1) {
                echo 'checked';
            } ?>>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <select class="form-control selectpicker" data-live-search="true" id="template_list"
                        name="template_list" aria-describedby="parent_idHelp" placeholder="Шаблон списка материалов">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <select class="form-control selectpicker" data-live-search="true" id="template_item"
                        name="template_item" aria-describedby="parent_idHelp"
                        placeholder="Шаблон детализации материалов">
                    <option value="NULL">нет</option>
                    <?php
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <select class="form-control selectpicker" data-live-search="true" id="template_admin"
                        name="template_admin" aria-describedby="parent_idHelp"
                        placeholder="Шаблон редактирования материалов">
                    <option value="NULL">нет</option>
                    <?php
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10"><?php
                ...
                ?>
                <input type="text" class="form-control" id="list_items" name="list_items"
                       aria-describedby="ordernumHelp" placeholder="Кол-во материалов на одной странице списка"
                       value="<?= $this->values->list_items ?>">
            </div>
        </div>
        <div class="form-check">
            <input type="checkbox" class="form-check-input" id="prepare_list" name="prepare_list"
                   value="1" <?php if ($this->values->prepare_list == 1) {
                echo 'checked';
            } ?>>
            <label for="prepare_list" class="form-check-label">Формирование списка материалов (нет логики в
                шаблоне)</label>
        </div>
        <div class="form-check">
            <input type="checkbox" class="form-check-input" id="prepare_item" name="prepare_item"
                   value="1" <?php if ($this->values->prepare_item == 1) {
                echo 'checked';
            } ?>>
        ...
        <div class="form-check">
            <input type="checkbox" class="form-check-input" id="shop_ifgood" name="shop_ifgood"
                   value="1" <?php if ($this->values->shop_ifgood == 1) {
                echo 'checked';
            } ?>>
        ...
        <div class="form-check">
            <input type="checkbox" class="form-check-input" id="shop_ifstore" name="shop_ifstore"
                   value="1" <?php if ($this->values->shop_ifstore == 1) {
                echo 'checked';
            } ?>>
